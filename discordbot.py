...
async def event(ctx):
        ...
        class1img = bs.select_one('#content > div > div > div > div > section.elementor-section.elementor-top-section.elementor-element.elementor-element-74bbde4.elementor-section-stretched.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default > div > div > div > div > div > section > div > div > div.elementor-column.elementor-col-50.elementor-inner-column.elementor-element.elementor-element-22ec587 > div > div > div.elementor-element.elementor-element-121a28d.elementor-widget.elementor-widget-image > div > div > img')['src']
        ...
        class2img = bs.select_one('#content > div > div > div > div > section.elementor-section.elementor-top-section.elementor-element.elementor-element-74bbde4.elementor-section-stretched.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default > div > div > div > div > div > section > div > div > div.elementor-column.elementor-col-50.elementor-inner-column.elementor-element.elementor-element-9b8ac8e > div > div > div.elementor-element.elementor-element-6c8627f.elementor-widget.elementor-widget-image > div > div > img')['src']
        ...
        embed.set_image(url=class1img)
        embed.add_field(name="클래스 1", value=f"{class1}\n [자세히 보기]({class1_url})", inline=True)     
        embed.set_image(url=class2img)
        embed.add_field(name="클래스 2", value=f"{class2}\n [자세히 보기]({class2_url})", inline=True)     
